...
int main(int argc, char *argv[])
{
  ...
  *********************************************/
  ...
  clientHelper.SetAttribute("MaxBytes", UintegerValue(300e6)); 
   ...
   *              TRACING - STUDY              *
  *********************************************/
  Simulator::Schedule(Seconds(1.00001), [](){Config::ConnectWithoutContext("/NodeList/0/$ns3::TcpL4Protocol/SocketList/0/CongestionWindow", MakeCallback(&CwndTracer));});
