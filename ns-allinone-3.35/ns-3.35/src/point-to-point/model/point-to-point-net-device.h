 ...
 */
   ...
   */
    ...
    /**
     * trace source fired for packets succesfully queued
     * (añadido)
     */
    TracedCallback<Ptr<const Packet>> m_queuedTrace;
    
    /**
     * trace source fired for packets succesfully dequeued 
     * (añadido)
     */

    TracedCallback<Ptr<const Packet>> m_dequeuedTrace;
